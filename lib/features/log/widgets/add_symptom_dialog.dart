...
/// Small "+ Add your own" body signal dialog shown from the daily log flow.
/// Returns the trimmed symptom name, or null if cancelled.
Future<String?> showAddSymptomDialog(BuildContext context) {
